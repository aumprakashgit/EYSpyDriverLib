========================================================================
    DYNAMIC LINK LIBRARY : EYSpyDriverLibrary Project Overview
========================================================================

EYSpyDriverLibrary.vcproj
	EYSpyDriverLibrary is a library that exposes one class called ControlProxy.  A ControlProxy 
...
Commands.cpp
Commands.h
	Commands contains handlers for custom window messages.  The way EYSpyDriverLibrary works is that
...
PropertyDescriptorProxy.cpp
	...
	used in the EYSpyDriver application by putting the ControlProxy in the PropertyGrid (The winforms propertygrid
